...
<h1><img src="SIBiLS_logo.png" alt="SIBiLS"></h1>
...
<figure markdown>
  ![graphical abstract](graphical_abstract.png){ loading=lazy style="width: calc(min(100%, 35rem)); margin: auto;" }
